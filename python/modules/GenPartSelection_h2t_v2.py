...
class GenPartSelection_h2t_v2(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        # for four-top
        self.out.branch(self.outputName + "_isL2t", "I") # n Leptonic tops
        self.out.branch(self.outputName + "_isH2t", "I") # n Hadronic tops
        self.out.branch(self.outputName + "_isO2t", "I") # n Other tops (should always be 4)
...
#                    topDict[topIdx]['quarks'].append(finalCopy)
    ...
    def analyze(self, event):
        ...
        for top in genTopList:
            ...
            # if we have more than 2 useful tops, we'll count these still but won't add it to the t1, t2 tops...
        ...
        # need to fill in remaining t1, t2
        if isHorL < 2:

            remaining_branches = 2 - isHorL
            null_list = [0.]
        ...
        self.out.fillBranch(self.outputName + "_isL2t", isL2t) # n Leptonic tops
        self.out.fillBranch(self.outputName + "_isH2t", isH2t) # n Hadronic tops
        self.out.fillBranch(self.outputName + "_isO2t", isO2t) # n Other tops
