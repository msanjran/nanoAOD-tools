...
class GenPartSelection_h4t(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch(self.outputName + "_isH4t", "I")
    ...
    def analyze(self, event):
        ...
        self.saveGenInfo(event) # get gen particle information (for later processing)

        # get hadronic with the signal daughter particles
        genHadronicTops = self.getGenTop(event)["hadronic"]
        
        self.out.fillBranch(self.outputName+"_isH4t", len(genHadronicTops))
